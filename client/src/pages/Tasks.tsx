            ...
            <CardContent>
              <Calendar
                ...
                classNames={{
                  ...
                  day_today: "bg-blue-600 text-white font-semibold rounded-md hover:bg-blue-700 !border-0 !outline-0 !ring-0 !shadow-none focus:!border-0 focus:!outline-0 focus:!ring-0"
                }}
              />
            </CardContent>
          </Card>
