...
-- Create invoice verification cache table for performance optimization
CREATE TABLE invoice_verification_cache (
    id SERIAL PRIMARY KEY,
...
CREATE INDEX idx_invoice_cache_key ON invoice_verification_cache(cache_key);
CREATE INDEX idx_invoice_cache_group_invoice ON invoice_verification_cache(group_id, invoice_reference);
CREATE INDEX idx_invoice_cache_expires_at ON invoice_verification_cache(expires_at);
CREATE INDEX idx_invoice_cache_delivery_id ON invoice_verification_cache(delivery_id);
